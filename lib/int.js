...
var bigint_digitsStr = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_=!@#$%^&*()[]{}|;:,.<>/? \\\'\"+-';
//var bigint_digitsStr = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_=!@#$%^&*()[]{}|;:,.<>/? \\\'\"+-';//need add `
                     //'0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ .,~!@#$%^&*()_-+=/{}\\\'|"?[]<>:;';//need add |
...
module.exports.convert = function(num,from_symbols,to_symbols) {
  ...
  //clog(bstr+' -> '+num2+' #'+num1+' ('+bint.toStr(10)+')');
  return num2;
}
